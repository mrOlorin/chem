...
<template>
    <svg width="80" height="80" class="element-info">
        <text x="2" y="12" font-size="0.6em">
            <title>Массовое число</title>
            {{atom.nucleus.A}}
        </text>
        <text x="2" y="23" font-size="0.6em">
            <title>Атомное число</title>
            {{atom.nucleus.Z}}
        </text>
        <text :x="10 + 3 * atom.nucleus.A.toString().length" y="22" font-size="1.2em">
            {{atom.nucleus.name}}
        </text>
        <text text-anchor="end" x="78" y="12" font-size="0.7em">
